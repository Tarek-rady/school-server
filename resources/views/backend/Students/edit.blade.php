                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input  type="text" name="name" value="{{$Student->getTranslation('name','ar')}}"  class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="gender_id">
                                        <option value="{{ $Student->id }}">{{ $Student->gender_id }}</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="nationalite_id">
                                        ...
                                        <option value="{{ $Student->id }}">{{ $Student->nationalite_id }}</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="blood_id">
                                        <option value="{{ $Student->id }}">{{ $Student->blood_id }}</option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="grade_id">
                                        <option value="{{  $Student->id  }}">{{  $Student->grade_id  }}</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="parent_id">
                                        <option value="{{  $Student->id  }}">{{  $Student->parent_id  }}</option>
